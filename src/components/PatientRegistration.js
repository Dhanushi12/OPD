  ...
  registerPatient(object) {
    ...
    axios.post('http://localhost:3001/patient/', {
      ...
      .then(function (response) {
        alert("registered");
          //object.props.history.push('/OverviewOfPatient');
    ...
    return (
      <div className="PatientRegistration">
        ...
        <div className="PatientPersonalDetails">
          <left><h2>Patient Personal Details</h2></left>
...
<div className="PatientIdentityDetails">
    ...
    <div className="PatientIdentityDetails">
          <left><h2>Patient Contact Details</h2></left>
    ...
    <div className="input-group mb-3">
      <div className="custom-file">
        ...
        <label className="custom-file-label" for="Choose_file">Choose file</label>
      </div>
   ...
   <div className="form-group">
    ...
    <div className="col-md-4">
      <button type="Save" className="btn btn-primary" onClick={()=>this.registerPatient(this)}>
      <Link style={{color:'black'}} params={{userId:123}} to={"/overviewofpatient"}>Save</Link></button>
    </div>
